...
class PastBookingDetailScreen extends Component {
        ...
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: Colors.bodyBackColor }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    {this.rateServiceProviderButton()}
                </View>
            </SafeAreaView>
        )
    }
    ...
    rateServiceProviderButton() {
        return (
            <TouchableOpacity
                activeOpacity={0.9}
                onPress={() => this.props.navigation.push('RateProvider')}
    ...
    bookingStatusInfo() {
        return (
            <View style={{ marginHorizontal: Sizes.fixPadding * 2.0, }}>
                ...
                {this.bookingStatus({
                    title: 'Job Completed',
                    description: 'Job completed at 12:05 PM',
                })}
            </View>
        )
    }
...
PastBookingDetailScreen.navigationOptions = () => {
    return {
        header: () => null,
...
export default withNavigation(PastBookingDetailScreen);
