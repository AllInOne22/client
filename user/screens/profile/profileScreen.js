            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: Colors.bodyBackColor }}>
                ...
                <View style={{ flex: 1, }}>
                    ...
                    >
                        ...
                        >
                            {this.moreInfo({ info: 'Notifications' })}
                        </TouchableOpacity>
        ...
        return (
            <View style={styles.userInfoWrapStyle}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    />
                    <Text numberOfLines={1} style={{ ...Fonts.blackColor18Bold, width: width - 200, marginLeft: Sizes.fixPadding * 2.0 }}>
                        Stella French
                    </Text>
                </View>
                <TouchableOpacity
